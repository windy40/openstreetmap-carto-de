...
#landcover[zoom >= 10] {
  ...
  [feature = 'leisure_pitch'][zoom >= 10] {
    ...
    [zoom >= 15] {
      ...
      /* this is currently just the same as the generic color */
...
#landcover-area-symbols {
  ...
  [natural = 'wood'][zoom >= 13]::wood {
    ...
    [leaf_type = "broadleaved"] { polygon-pattern-file: url('symbols-de/leaftype_broadleaved.svg'); }
    [leaf_type = "needleleaved"] { polygon-pattern-file: url('symbols-de/leaftype_needleleaved.svg'); }
    [leaf_type = "mixed"] { polygon-pattern-file: url('symbols-de/leaftype_mixed.svg'); }
